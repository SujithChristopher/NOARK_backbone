...
class MainClass:
 ...
 def _get_local_coordinates(self, ids, rvecs, tvecs):
        ...
        # print("pos in table frame:", pos_in_table_frame * 100)
 ...
 def process_frame(self):
        ...
        #    Print each marker's position in camera frame
            for i, marker_id in enumerate(ids.flatten()):
                # print(f"Marker ID: {marker_id}, Position in camera frame: {tvecs[i]* 100} cm")
                                                                       
             self.noark_in_table_frame = self._get_local_coordinates(ids, rvecs, tvecs) #Final NOARK position in table frame 
